...
\begin{DoxyCompactList}\small\item\em This function is used to obtain bounding-\/box for a cluster of points. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename PointT $>$ }\\\mbox{\hyperlink{structtapl_1_1BBox3d}{tapl\+::\+B\+Box3d}} \mbox{\hyperlink{namespacetapl_1_1pte_a401e02a4396f1cd95d565211768af563}{get\+Oriented\+Bounding\+Box}} (typename pcl\+::\+Point\+Cloud$<$ PointT $>$\+::Ptr cloud\+Cluster)
...
\mbox{\Hypertarget{namespacetapl_1_1pte_a401e02a4396f1cd95d565211768af563}\label{namespacetapl_1_1pte_a401e02a4396f1cd95d565211768af563}} 
\index{tapl::pte@{tapl::pte}!getOrientedBoundingBox@{getOrientedBoundingBox}}
\index{getOrientedBoundingBox@{getOrientedBoundingBox}!tapl::pte@{tapl::pte}}
\doxysubsubsection{\texorpdfstring{getOrientedBoundingBox()}{getOrientedBoundingBox()}}
{\footnotesize\ttfamily template$<$typename PointT $>$ \\
\mbox{\hyperlink{structtapl_1_1BBox3d}{tapl\+::\+B\+Box3d}} tapl\+::pte\+::get\+Oriented\+Bounding\+Box (\begin{DoxyParamCaption}\item[{typename pcl\+::\+Point\+Cloud$<$ PointT $>$\+::Ptr}]{cloud\+Cluster }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Oriented3D Bounding-\/\+Box 
\end{DoxyReturn}
This line is necessary for proper orientation in some cases. The numbers come out the same without it, but the signs are different and the box doesn\textquotesingle{}t get correctly oriented in some cases.

Definition at line 402 of file pt\+Engine.\+hpp.
